...
function Board:initializeTiles(level)
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            shiny = math.random(5)
            if shiny == 1 then
                -- the first tile in the first level
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(6, 13), math.random(self.level), true))
            else
                -- normal tile
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(6, 13), math.random(self.level), false))
            end
        end
    end
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                -- replace the tile with random color and the same variety
...
-- function to check match existence
function Board:checkMatchExistence()
    local possibleMatches = false
